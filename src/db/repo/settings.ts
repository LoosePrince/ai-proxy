...
function toSettings(raw: Record<string, string>): SettingsDTO {
  ...
  return {
    ...
    globalSystemPromptEnabled: normalizeBoolean(
      raw.globalSystemPromptEnabled,
      Boolean(raw.globalSystemPrompt?.trim()),
    ),
    ideRequestHandlingEnabled: normalizeBoolean(
      raw.ideRequestHandlingEnabled,
      HARD_DEFAULTS.ideRequestHandlingEnabled,
    ),
    maliciousRequestHandlingEnabled: normalizeBoolean(
      raw.maliciousRequestHandlingEnabled,
      HARD_DEFAULTS.maliciousRequestHandlingEnabled,
    ),
...
export async function seedSettingsFromEnv(): Promise<void> {
  ...
  const seeds: Record<string, string | number | boolean> = {
    ...
    globalSystemPromptEnabled: HARD_DEFAULTS.globalSystemPromptEnabled,
    ideRequestHandlingEnabled: HARD_DEFAULTS.ideRequestHandlingEnabled,
    maliciousRequestHandlingEnabled: HARD_DEFAULTS.maliciousRequestHandlingEnabled,
